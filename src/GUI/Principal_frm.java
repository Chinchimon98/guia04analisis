...
//        getLayeredPane().add(fondo, JLayeredPane.FRAME_CONTENT_LAYER);
    ...
    private void initComponents() {
        ...
        txtPuntosN = new javax.swing.JTextArea();
        ...
        txtPuntosN.setColumns(20);
        txtPuntosN.setRows(5);
        jScrollPane7.setViewportView(txtPuntosN);
...
//        numeroPuntos.setText(colum+"");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double[][] matriz = getValores(), tablita;
        switch (opcion) {
            case 1:
                double x[] = {matriz[0][0], matriz[0][1], matriz[0][2], matriz[0][3], matriz[0][4]},
                 y[] = {matriz[1][0], matriz[1][1], matriz[1][2], matriz[1][3], matriz[1][4]};
                tablita = newton.calcularDifDiv(x, y);

                for (int j = 0; j < x.length; j++) {
                    for (int k = 0; k < x.length + 1; k++) {
                        yitexarea.append(Double.toString(tablita[j][k]) + " | ");
                    }
                    yitexarea.append("\n");
                }
            ...
            case 2:
                double x2[] = {matriz[0][0], matriz[0][1], matriz[0][2], matriz[0][3]},
                 y2[] = {matriz[1][0], matriz[1][1], matriz[1][2], matriz[1][3]};
                tablita = newton.calcularDifDiv(x2, y2);
                
                for (int j = 0; j < x2.length; j++) {
                    for (int k = 0; k < x2.length + 1; k++) {
                        yitexarea.append(Double.toString(tablita[j][k]) + " | ");
                    }
                    yitexarea.append("\n");
                }
            ...
            case 3:
                double x3[] = {matriz[0][0], matriz[0][1], matriz[0][2]},
                 y3[] = {matriz[1][0], matriz[1][1], matriz[1][2]};
                tablita = newton.calcularDifDiv(x3, y3);
                
                for (int j = 0; j < x3.length; j++) {
                    for (int k = 0; k < x3.length + 1; k++) {
                        yitexarea.append(Double.toString(tablita[j][k]) + " | ");
                    }
                    yitexarea.append("\n");
                }
            ...
            case 4:
                double x4[] = {matriz[0][0], matriz[0][1], matriz[0][2]},
                 y4[] = {matriz[1][0], matriz[1][1], matriz[1][2]};
                tablita = newton.calcularDifDiv(x4, y4);
                
                for (int j = 0; j < x4.length; j++) {
                    for (int k = 0; k < x4.length + 1; k++) {
                        yitexarea.append(Double.toString(tablita[j][k]) + " | ");
                    }
                    yitexarea.append("\n");
                }
        ...
        if (opcion > 0 && opcion < 5) {
            ...
            switch (opcion) {
                case 1:
                    double x[] = {matriz[0][0], matriz[0][1], matriz[0][2], matriz[0][3], matriz[0][4]},
                     y[] = {matriz[1][0], matriz[1][1], matriz[1][2], matriz[1][3], matriz[1][4]};
                    polinomio = newton.getPolinomio(x, y);

                    for (int j = 0; j < 4; j++) {
                        punto = String.valueOf(funcion.evaluarFuncion(Double.parseDouble(puntos[j]), polinomio));
                        txtPuntosN.append("P(" + puntos[j] + ") = " + punto + "\n");
                        System.out.println(punto);
                    }
                    break;
                ...
                case 2:
                    double x2[] = {matriz[0][0], matriz[0][1], matriz[0][2], matriz[0][3]},
                     y2[] = {matriz[1][0], matriz[1][1], matriz[1][2], matriz[1][3]};
                    polinomio = newton.getPolinomio(x2, y2);

                    punto = String.valueOf(funcion.evaluarFuncion(4, polinomio));
                    txtPuntosN.append("P(4) = " + punto + "\n");
                ...
                case 3:
                    double x3[] = {matriz[0][0], matriz[0][1], matriz[0][2]},
                     y3[] = {matriz[1][0], matriz[1][1], matriz[1][2]};
                    polinomio = newton.getPolinomio(x3, y3);
                    break;

                case 4:
                    double x4[] = {matriz[0][0], matriz[0][1], matriz[0][2]},
                     y4[] = {matriz[1][0], matriz[1][1], matriz[1][2]};
                    polinomio = newton.getPolinomio(x4, y4);

                    punto = String.valueOf(funcion.evaluarFuncion(Math.PI / 6, polinomio));
                    txtPuntosN.append("P(PI/6) = " + punto + "\n");
                    break;
            }

            txtnewton.append("p(x) = " + polinomio);
        }
    ...
    private javax.swing.JTextArea txtPuntosN;
