...
public class GraficadorClasico extends JPanel
{
    ...
    Principal_frm ppal = new Principal_frm();
        String val = ppal.d2();
        ...
        campoNoPuntos = new JTextField("99",3);
               ...
               campoFuncion = new JTextField(val,15);
...
//x^3+2x^2+7x-20//cos(x)--------*****
        ...
        campoDerivada.setVisible(false);
      campoIntervaloA.setVisible(false);
campoIntervaloB.setVisible(false);
      campoNumeroDeInteraciones.setVisible(false);
      campoNoPuntos.setVisible(false);
        etiquetaA.setVisible(false);
        etiquetaB.setVisible(false);
        etiquetaInteraciones.setVisible(false);
        etiquetaNumPuntos.setVisible(false);
...
public class ZonaGrafica extends JPanel  implements MouseListener, MouseMotionListener, MouseWheelListener
{
    ...
    void Graficar(Graphics ap, int xg, int yg)
    {
        ...
        if(!errorEnExpresion)
        {
            Mensaje.setText("Gráfica :)");//:. Arraátre el mouse para mover ejes.");
